---
title: "Typical Electronic Failures in Three Phases of Bathtub Curve"
...
- Thermal management issues (e.g. inadequately sized heat sinks for power transistors)

- Timing margin problems

- Material coefficient of expansion (CTE) mismatch (e.g. between ceramic and copper)
...
- Printed wiring board (PWB) defects (e.g. cracked vias, defective solder mask)

## Sources

- SAE G-11 Reliability, Maintainability and Supportability Guidebook:  Environmental Stress Screening
